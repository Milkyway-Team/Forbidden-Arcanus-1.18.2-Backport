...
public class ModRecipes {
    ...
    public static final DeferredRegister<RecipeType<?>> RECIPE_TYPES = DeferredRegister.create((ResourceLocation) ForgeRegistries.RECIPE_SERIALIZERS, ForbiddenArcanus.MOD_ID);
    ...
    public static final RegistryObject<RecipeSerializer<IncreaseEdelwoodBucketFullnessRecipe>> EDELWOOD_BUCKET_INCREASE_FULLNESS = register("increase_edelwood_bucket_fullness", new SimpleRecipeSerializer<>(IncreaseEdelwoodBucketFullnessRecipe::new));    public static final RegistryObject<RecipeSerializer<ApplyModifierRecipe>> APPLY_MODIFIER = register("apply_modifier", new ApplyModifierRecipe.Serializer());
